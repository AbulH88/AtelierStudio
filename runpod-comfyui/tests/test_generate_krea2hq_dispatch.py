...
def test_generate_dispatches_krea2hq_without_network(monkeypatch):
    calls = {}
    ...
    inp = {"mode": "krea2hq", "prompt": "a woman in red",
    ...
    assert calls["graph"]["16"]["inputs"]["image"] == "uploaded_frame.png"
    assert calls["graph"]["5"]["inputs"]["text"] == "ing2lorance, a woman in red"
