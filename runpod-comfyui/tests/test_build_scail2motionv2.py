...
def test_build_scail2motionv2_crops_reference_to_original_driving_video_shape():
    graph = _load_graph()
...
def test_build_scail2motionv2_generation_resolution_presets_and_safe_default():
...
def test_build_scail2motionv2_uses_the_installed_scail2_model_path():
    graph = _load_graph()
